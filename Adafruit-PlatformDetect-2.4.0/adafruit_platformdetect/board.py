...
class Board:
    ...
    @property
    def any_zynqberry_board(self):
        """Check whether the current board is any defined ZYNQBERRY Board."""
        return self.id in boards._ZYNQBERRY_IDS
